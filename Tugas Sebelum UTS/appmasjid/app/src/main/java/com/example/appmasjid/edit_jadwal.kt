...
class edit_jadwal : AppCompatActivity() {
    ...
    fun upsbh(sbh:String) {
        AndroidNetworking.post("http://10.35.150.220/API/proses-jadwal.php")
    ...
    fun updzh(dzhr:String){
        AndroidNetworking.post("http://10.35.150.220/API/proses-dzuhur.php")
    ...
    fun updasar(asr:String){
        AndroidNetworking.post("http://10.35.150.220/API/proses-ashar.php")
    ...
    fun updmrib(mrb:String){
        AndroidNetworking.post("http://10.35.150.220/API/proses-maghrib.php")
    ...
    fun updisya(isa:String){
        AndroidNetworking.post("http://10.35.150.220/API/proses-isa.php")
    ...
    fun upddh(duha:String){
        AndroidNetworking.post("http://10.35.150.220/API/proses-dhuha.php")
